...
function SecondaryStory({ article }: { article: Article }) {
  return (
    <article className="group border-t border-line first:border-t-0">
      <Link
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.7fr)_minmax(18rem,0.7fr)] lg:gap-10">
            {featured ? (
              <article className="min-w-0">
                <Link
                  ...
                  className="group block overflow-hidden rounded-2xl border border-line bg-surface/45 shadow-sm transition-[border-color,box-shadow,transform] duration-300 active:scale-[0.99] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sand sm:hover:border-line-strong sm:hover:shadow-[0_24px_60px_-36px_rgb(var(--sand)/0.45)]"
                >
            ...
            <aside aria-labelledby="latest-cover-title">
              <div className="flex items-center justify-between border-b-2 border-sand pb-3">
                ...
                <span className="font-mono text-[0.65rem] uppercase tracking-[0.08em] text-fg-faint">
                  Más recientes
                </span>
              </div>
